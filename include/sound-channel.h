...
extern float sound_channel_hz[SOUND_MAX_CHANNELS];
extern uint16_t sound_channel_porta[SOUND_MAX_CHANNELS];
extern uint8_t sound_channel_porta_state[SOUND_MAX_CHANNELS];
